#############################################################################
# Makefile for building: bbc-lc
# Generated by qmake (3.0) (Qt 5.2.1)
# Project:  bbc-lc.pro
# Template: app
# Command: /usr/lib/x86_64-linux-gnu/qt5/bin/qmake -spec linux-g++-64 CONFIG+=debug CONFIG+=declarative_debug CONFIG+=qml_debug -o Makefile bbc-lc.pro
#############################################################################
...
CC            = gcc
CXX           = g++
DEFINES       = -DQT_QML_DEBUG -DQT_DECLARATIVE_DEBUG -DQT_WEBKIT_LIB -DQT_WIDGETS_LIB -DQT_NETWORK_LIB -DQT_GUI_LIB -DQT_CORE_LIB
CFLAGS        = -m64 -pipe -g -Wall -W -D_REENTRANT -fPIE $(DEFINES)
CXXFLAGS      = -m64 -pipe -std=c++11 -g -Wall -W -D_REENTRANT -fPIE $(DEFINES)
INCPATH       = -I/usr/lib/x86_64-linux-gnu/qt5/mkspecs/linux-g++-64 -I. -I/usr/include/qt5 -I/usr/include/qt5/QtWebKit -I/usr/include/qt5/QtWidgets -I/usr/include/qt5/QtNetwork -I/usr/include/qt5/QtGui -I/usr/include/qt5/QtCore -I. -I.
LINK          = g++
LFLAGS        = -m64 -Wl,-rpath-link,/usr/lib/x86_64-linux-gnu
LIBS          = $(SUBLIBS) -L/usr/X11R6/lib64 -lQt5WebKit -L/usr/lib/x86_64-linux-gnu -lQt5Widgets -lQt5Network -lQt5Gui -lQt5Core -lGL -lpthread 
AR            = ar cqs
RANLIB        = 
...
Makefile: bbc-lc.pro /usr/lib/x86_64-linux-gnu/qt5/mkspecs/linux-g++-64/qmake.conf /usr/lib/x86_64-linux-gnu/qt5/mkspecs/features/spec_pre.prf \
		/usr/lib/x86_64-linux-gnu/qt5/mkspecs/common/shell-unix.conf \
		/usr/lib/x86_64-linux-gnu/qt5/mkspecs/common/unix.conf \
		/usr/lib/x86_64-linux-gnu/qt5/mkspecs/common/linux.conf \
		/usr/lib/x86_64-linux-gnu/qt5/mkspecs/common/gcc-base.conf \
	...
	$(QMAKE) -spec linux-g++-64 CONFIG+=debug CONFIG+=declarative_debug CONFIG+=qml_debug -o Makefile bbc-lc.pro
...
dist: 
	@test -d .tmp/bbc-lc1.0.0 || mkdir -p .tmp/bbc-lc1.0.0
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/bbc-lc1.0.0/ && $(COPY_FILE) --parents mainview.h commentarymodel.h competition.h game.h iobserver.h .tmp/bbc-lc1.0.0/ && $(COPY_FILE) --parents main.cpp mainview.cpp commentarymodel.cpp competition.cpp game.cpp .tmp/bbc-lc1.0.0/ && $(COPY_FILE) --parents mainview.ui .tmp/bbc-lc1.0.0/ && (cd `dirname .tmp/bbc-lc1.0.0` && $(TAR) bbc-lc1.0.0.tar bbc-lc1.0.0 && $(COMPRESS) bbc-lc1.0.0.tar) && $(MOVE) `dirname .tmp/bbc-lc1.0.0`/bbc-lc1.0.0.tar.gz . && $(DEL_FILE) -r .tmp/bbc-lc1.0.0
...
compiler_rcc_clean:
compiler_moc_header_make_all: moc_mainview.cpp
compiler_moc_header_clean:
	-$(DEL_FILE) moc_mainview.cpp
moc_mainview.cpp: /usr/include/qt5/QtWidgets/QMainWindow \
...
commentarymodel.o: commentarymodel.cpp commentarymodel.h \
		competition.h \
		game.h \
		iobserver.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o commentarymodel.o commentarymodel.cpp

competition.o: competition.cpp competition.h \
		game.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o competition.o competition.cpp
